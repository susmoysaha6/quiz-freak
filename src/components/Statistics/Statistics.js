...
import { Bar, BarChart, CartesianGrid, ComposedChart, Funnel, FunnelChart, LabelList, Legend, Line, LineChart, Pie, PieChart, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
...
const Statistics = () => {
    ...
    return (
        <div className='w-11/12 mx-auto'>
            ...
            <div className='grid md:grid-cols-2  mt-16 gap-2'>
